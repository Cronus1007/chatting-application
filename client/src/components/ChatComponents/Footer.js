...
const Footer = () => {
    return (
        ...
        Copyright© 2021 { " " } <
        span style = {
            { color: "deepskyblue", fontWeight: 500 } } > Karishma Vanwari < /span> <
        /span> <
        div style = {
            { marginTop: 10 } } >
        <
        ...
        <
        GitHubIcon style = {
            { marginRight: "10px", fontSize: 27 } }
        /> <
        /a> <
        a href = "https://www.linkedin.com/in/ritish-thareja-668465197/"
        target = "_blank" >
        <
        LinkedInIcon style = {
            { marginRight: "10px", fontSize: 30 } }
        /> <
        /a> <
        a href = "mailto:ritishthareja10@gmail.com"
        target = "_blank" >
        <
        MailIcon style = {
            { marginRight: "10px", fontSize: 30 } }
